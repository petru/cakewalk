...
module Cakewalk
  ...
  class Channel < Target
    ...
    # @deprecated
    def msg(*args)
      Cakewalk::Utilities::Deprecation.print_deprecation("2.2.0", "Channel#msg", "Channel#send")
      send(*args)
    end

    # @deprecated
    def privmsg(*args)
      Cakewalk::Utilities::Deprecation.print_deprecation("2.2.0", "Channel#privmsg", "Channel#send")
      send(*args)
    end
    ...
    def to_str
      Cakewalk::Utilities::Deprecation.print_deprecation("2.2.0", "Channel#to_str", "Channel#to_s")
      to_s
    end
